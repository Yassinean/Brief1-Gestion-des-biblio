        ...
        do {
            ...
            switch (choix) {
                case 1 -> {
                    ...
                    switch (switchDoc) {
                        case 1 -> {
                            String titreL = getStringInput(scan,
                                    "Veuillez saisir le titre du livre : ");
                            String auteurL = getStringInput(scan,
                                    "Veuillez saisir l'auteur du livre : ");
                            int nbrePageL = getIntInput(scan,
                                    "Veuillez saisir le nombre de pages du livre : ");
                            String datePubL = getDateInput(
                                    scan,
                                    "Veuillez saisir la date de publication du livre (dd/MM/yyyy) : ");
                            String isbn = getStringInput(
                                    scan, "Veuillez saisir l'ISBN du livre : ");

                            Livre livre = new Livre(titreL, auteurL, datePubL, nbrePageL, isbn);
                            bibliotheque
                                    .AjouterDocument(livre);
                            System.out
                                    .println("Livre " + titreL + " ajouté avec succès.");
                        }
                        case 2 -> {
                            ...
                            Magazine magazine = new Magazine(titreM, auteurM, datePubM, nbrePageM, numero);
